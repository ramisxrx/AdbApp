...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + TABLE_NAMES + " (" + COLUMN_ID +
                " INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE NOT NULL, " + COLUMN_NAME +
                " TEXT);");

        db.execSQL("CREATE TABLE " + TABLE_FIELDS + " (" + COLUMN_ID +
            " INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE NOT NULL, " + COLUMN_TYPE_ID +
            " INTEGER, " + COLUMN_NAME_ID + " INTEGER NOT NULL, FOREIGN KEY (" + COLUMN_NAME_ID + ") REFERENCES "
            + TABLE_NAMES + "(" + COLUMN_ID + ");");
